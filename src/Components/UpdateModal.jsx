...
const UpdateModal = ({ event, onClose, onUpdate }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/50 flex items-center justify-center">
      <Zoom className="bg-white dark:bg-slate-800 p-6 rounded shadow max-w-lg w-full relative">
        <div>
          <button
            type="button"
            onClick={onClose}
            className="absolute top-3 right-3 cursor-pointer hover:text-red-600"
          >
            <RxCross2 size={23} />
          </button>
