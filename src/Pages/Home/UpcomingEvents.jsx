...
const UpcomingEvents = () => {
  ...
  return (
    <div id="featuredEvents" className="w-11/12 md:w-4/5 mx-auto flex flex-col items-center justify-center">
            ...
            <div className="max-w-md mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 hover:shadow-2xl transition-shadow duration-300">
              <div className="p-6">
                ...
                <div className="flex items-center justify-between mt-4">
                  <span className="text-sm text-gray-800 dark:text-gray-100 border border-gray-500 px-3 py-3 rounded">
                    Attendees:{" "}
                    <strong>
